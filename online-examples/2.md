...
- Use shadcn for cross-platform UI components and styling.
...
- Use prisma orm + postgresql for backend services, including authentication and database interactions.
- Follow planetscale guidelines for security and performance.
