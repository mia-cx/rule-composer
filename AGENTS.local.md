...
- **Colors** — OKLCH color space for design tokens (e.g., `oklch(0.141 0.005 285.823)`).
- **Theming** — `data-theme` attribute (`[data-theme='dark']`, `[data-theme='light']`, `[data-theme='auto']`). Auto mode uses `prefers-color-scheme`.
