...
Use consistent patterns across the codebase. Claude Code should follow these conventions strictly.
...
These rules define conventions for AI coding agents working in this project. Rules are stored in `.claude/rules/` as `.md` files.
