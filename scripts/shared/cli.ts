...
export const showDiffPreview = (
  ...
  p.log.info(
    `Before: ~${originalTokens} tokens | After: ~${optimizedTokens} tokens (${pct}% savings)`,
  );
};
...
/** Pick output targets */
export const pickOutputTargets = async (
  detected: DiscoveredSource[],
  targetTool: ToolId,
